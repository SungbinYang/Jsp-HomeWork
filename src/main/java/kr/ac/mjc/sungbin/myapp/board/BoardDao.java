...
public class BoardDao {
	...
	private final String UPDATE_CNT = "update board set cnt=cnt+1 where seq=?";
	...
	public int addBoard(Board board) {
		return dbUtils.update(ADD_BOARD, board.getTitle(), board.getContent(), board.getWriter());
	}
	...
	public int updateBoard(Board board) {
		return dbUtils.update(UPDATE_BOARD, board.getTitle(), board.getContent(), board.getSeq());
	}
	...
	public int updateCnt(String seq) { // 조회수 증가 SQL문을 이용한 처리
		return dbUtils.update(UPDATE_CNT, seq);
	}
