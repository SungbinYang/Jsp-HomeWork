...
public class BoardController {
	...
	public void boardList(HttpServletRequest request, HttpServletResponse response) {
		...
		if(request.getParameter("pageNumber") == null)
			pageNumber = "1";
		else  pageNumber = request.getParameter("pageNumber");
		List<Board> boardList = boardDao.listBoards(10, Integer.parseInt(pageNumber));
	...
	public void addBoard(HttpServletRequest request, HttpServletResponse response) {
		...
		redirect(request, response, "/app/board/boardList?pageNumber=1");
	}
